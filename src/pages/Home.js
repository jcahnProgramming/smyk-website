...
const Home = () => {
    return (
        <div className='home__centered'>
            ...
            <DataCard img={require('../img/officerapplication@2x.png')} handlerType='' buttonText='Apply' title='Officer Applications' text='Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Diam vel quam elementum pulvinar etiam non quam lacus suspendisse.'/>
        </div>
    );
}
export default Home;